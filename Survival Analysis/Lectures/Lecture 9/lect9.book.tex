%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Use the commands below for two column printing %
%%  Use the unix command dvips -t landscape file   %
%%  when printing off the latex file               %
%%  Comment these out when not in 2-column mode    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\documentstyle[11pt,2up,psfig]{article}
%\setlength{\topmargin}{-0.5cm}
%\setlength{\oddsidemargin}{0.25in}
%\setlength{\evensidemargin}{-1.5in}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Use the commands below for one-column printing  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\newpagestyle{200t}{\\Principles of Biostatistics \hfil}{\thepage}
...
%\articlemag{0}
%\twoup[1]
%\newpagestyle{200t}{\\Principles of Biostatistics \hfil}{}
%\pagestyle{200t}
%\slidepagestyle{200t}
...
\include{envir223}
\begin{document}\setcounter{page}{151}\setcounter{chapter}{9}
...
\end{center}
\end{document}
\chapter{The Accelerated Failure Time Model}
...
relationships
\subsection{For the Exponential Model:}
...
\subsection{For the Weibull Model:}
...
distribution.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Relationship between Exponential and Weibull}
...
\section{Effect of AFT on hazard}
\begin{eqnarray*}
...
\section{Special cases of AFT models}
\begin{itemize}
